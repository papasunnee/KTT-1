    ...
    render(){
        return(
            <div>
                ...
                <div className="container well animated fadeIn">
                            ...
                            <div className="carousel-inner">
                                        ...
                                        <div className="row spacer-md">
                                            <div className="col-sm-12 col-md-5 col-md-offset-1">
                                                <div className="animated fadeInLeftBig slide-delay-1">
                                                    <h1 className="WhiteText content-right">Any Title (if necessary)</h1>
                                                </div>
                                                <h3 className="animated fadeInLeftBig slide-delay-2 YellowText">
                                                    Nigeria is a resource rich country with a GDP of 31 trillion naira but 75% of its polulation living in abject poverty
                                                </h3>
                                            </div>
                                ...
                                <div className="item">
                                    <div className="container-fluid">
                                        <div className="row spacer-md">
                                            <div className="col-sm-12 col-md-5 col-md-offset-1">
                                                <img className="img-responsive rollIn" src="/static/images/dice.png" alt="" />
                                            </div>
                                            <div className="col-sm-12 col-md-6">

                                                <div className="content-right animated rotateInDownRight slide-delay-1">
                                                    <h2 className="WhiteText">Any Title (if any)</h2>
                                                </div>
                                ...
                                <div className="item">
                                    <div className="container-fluid">
                                        <div className="row spacer-md">
                                            <div className="col-sm-12 col-md-5 col-md-offset-1">
                                                <img className="img-responsive animated rollIn" src="http://www.techalpha.info/button.png" alt="" />
                                            </div>
                                            <div className="col-sm-12 col-md-6">
                                                <div className="content-right animated rotateInDownRight slide-delay-1">
                                                    <h2 className="WhiteText">Any Title (if any)</h2>
                                    ...
                                    <div className="container">
                                        <div className="row spacer-md">
                                            <div className="col-sm-12 col-md-5 col-md-offset-1">
                                                ...
                                                <h3 className="animated fadeInUpBig slide-delay-2 YellowText">
                                                    Unemployment is worst in the history of Nigeria.
                                                </h3>
                                            </div>

                                            <div className="col-sm-12 col-md-6">
                                                <img className="img-responsive animated bounceInDown" src="http://www.techalpha.info/book.png" alt="" />
                                            </div>
...
export default withLayout(FactSlider)