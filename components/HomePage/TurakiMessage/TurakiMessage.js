...
//        backgroundSize: "cover"
      ...
      <div className="shell-wide">
        ...
        <div className="cell-xs-12 cell-md-6 cell-xl-6">
          ...
          fair chance to succeed in life, where quality education and healthcare are 
          priorities and affordable to the ordinary citizen, where our youth full of energy
          and talents are able to rightly pursue their dreams, where everyone feels
          ...
          abroad.<br /> We dare to dream because Nigerians deserve better and there must
          ...
          <div className="offset-top-20 offset-md-top-40" style={{ fontFamily: 'Mrs Saint Delafield, cursive', fontSize : '40px', fontColor:'pink', fontWeight : 'bolder', textAlign: 'right' }}>Kabiru Tanimu Turaki</div>
